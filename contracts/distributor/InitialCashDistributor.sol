...
import '../distribution/YFLUSDBONKPool.sol';
import '../distribution/YFLUSDDOKIPool.sol';
import '../distribution/YFLUSDLINKPool.sol';
import '../distribution/YFLUSDMASQPool.sol';
import '../distribution/YFLUSDSYAXPool.sol';
import '../distribution/YFLUSDYYFLPool.sol';
...
contract InitialCashDistributor is IDistributor {
    ...
    constructor(
        ...
        require(_pools.length != 0, 'a list of YFLUSD pools are required');
